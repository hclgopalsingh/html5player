...
@Component({
    selector: 'tempnine',
    templateUrl: '../view/layout/templatenine.component.html',
    styleUrls: ['../view/css/templatenine.component.css', '../view/css/bootstrap.min.css'],
	 ...
	 @ViewChild('maincontent') maincontent:any;
		...
		checkAnswer(option,event,idx) {
			...
			if(option.id==this.feedback.correct_ans_index){
				...
				this.ansBlock.nativeElement.className="d-flex align-items-center justify-content-center disable";
				...
				this.buzzerSound.nativeElement.onended = () => {
					...
					setTimeout(()=>{
						this.ansBlock.nativeElement.className="d-flex align-items-center justify-content-center";	
					},200)
				}
