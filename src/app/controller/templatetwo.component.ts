...
@Component({
    selector: 'temptwo',
    templateUrl: '../view/layout/templatetwo.component.html',
    styleUrls: ['../view/css/templatetwo.component.css', '../view/css/bootstrap.min.css'],

})

export class TemplatetwoComponent extends Base implements OnInit{
