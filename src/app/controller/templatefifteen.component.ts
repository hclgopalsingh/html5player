...
@Component({
    selector: 'tempfifteen',
    templateUrl: '../view/layout/templatefifteen.component.html',
    styleUrls: ['../view/css/templatefifteen.component.css', '../view/css/bootstrap.min.css'],

})

export class TemplatefifteenComponent implements OnInit{
