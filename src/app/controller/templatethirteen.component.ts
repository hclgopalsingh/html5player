...
@Component({
    selector: 'tempthirteen',
    templateUrl: '../view/layout/templatethirteen.component.html',
    styleUrls: ['../view/css/templatethirteen.component.css', '../view/css/bootstrap.min.css']

})

export class TemplatethirteenComponent implements OnInit{
