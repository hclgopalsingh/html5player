...
@Component({
  ...
  templateUrl: '../view/layout/Ntemplate23.component.html',
  styleUrls: ['../view/css/Ntemplate23.component.css', '../view/css/bootstrap.min.css'],
  encapsulation: ViewEncapsulation.None
})

export class Ntemplate23 implements OnInit {
