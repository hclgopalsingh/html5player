...
@Component({
  selector: 'ntemp19',
  templateUrl: '../view/layout/Ntemplate19.component.html',
  styleUrls: ['../view/css/Ntemplate19.component.css', '../view/css/bootstrap.min.css'],

})

export class Ntemplate19 implements OnInit {
...
houtSkip(){
  ...
  setData() {
    ...
    if (this.appModel && this.appModel.content && this.appModel.content.contentData && this.appModel.content.contentData.data) {
      ...
      this.tabularBlockObj = fetchedData.tabularBlockObj;
