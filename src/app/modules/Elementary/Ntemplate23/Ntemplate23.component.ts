...
export class Ntemplate23Component implements OnInit {
  ...
  MouseOver(event) {
    ...
    if (this.Id == null) {
      if (this.stateIndex != undefined && this.myStates[this.stateIndex] != undefined && !this.myStates[this.stateIndex].clicked) {
        ...
        document.querySelector(this.QuesRef.nativeElement.children[1].children[this.stateIndex + 1].children[0].children[0].getAttribute("xlink:href")).children[0].setAttribute("fill", this.originalcolor);
    ...
    if (idFound && !idFound.clicked) {
      ...
      this.originalcolor = document.querySelector(this.QuesRef.nativeElement.children[1].children[this.stateIndex + 1].children[0].children[0].getAttribute("xlink:href")).children[0].getAttribute("fill");
      //this.storeHtml = this.QuesRef.nativeElement.children[0].children[this.stateIndex+1].innerHTML;
      if (this.stateIndex != -1) {
        document.querySelector(this.QuesRef.nativeElement.children[1].children[this.stateIndex + 1].children[0].children[0].getAttribute("xlink:href")).children[0].setAttribute("fill", this.mainSvgfile.hoverColor);
  ...
  play(i) {
    ...
    this.myAudio.nativeElement.src = this.myStates[i].audio;
  ...
  {	 
    if(!this.singleClicknotAllowed) {
      ...
      if(idFound && !idFound.clicked) {
        ...
        document.querySelector(document.getElementById("mainques").children[1].children[this.stateIndex+1].children[0].children[0].getAttribute("xlink:href")).children[0].setAttribute("fill",idFound.onclickColor);
  ...
  checkStateStatus(state) {
   ...
   ondblClick(event) {
    ...
    document.getElementById("dropdown").style.pointerEvents="none";
      ...
      if(idFound) {
        this.countofClick--;
        $(document.getElementById("mainques").children[1].children[this.stateIndex+1].children[0].children[0].getAttribute("xlink:href"))[0].children[0].setAttribute("fill",this.originalcolor);
